...
export const lists = [
  {
    ...
    wineInfo: [
      {
        title: "最佳饮用期",
        content: `<div class='collapse__wrap-text'>2022年</div>`,
      },
      {
        title: "口感",
        content: `<div class='collapse__subtitle'>色泽</div><div class='collapse__wrap-text'>宝石红色</div><div class='collapse__subtitle'>香气</div><div class='collapse__wrap-text'>浓郁的黑加仑、香草和淡雅的烟熏香</div><div class='collapse__subtitle'>口感</div><div class='collapse__wrap-text'>酒体浓郁, 如丝般柔顺, 回味悠长, 好像带有法国南部太阳的甜香. 佳丽酿葡萄赋予这款佳酿红色水果芳香和单宁的完整结构.</div>`,
      },
      {
        title: "情况说明",
  ...
  },
  {
    ...
    wineInfo: [
      ...
      {
        title: "口感",
        content: `<div class='collapse__subtitle'>色泽</div><div class='collapse__wrap-text'>宝石红色</div><div class='collapse__subtitle'>香气</div><div class='collapse__wrap-text'>浓郁的黑色水果桑果 黑樱桃气息,同时伴有焦油和烤面包味,尾调有香草的芳香</div><div class='collapse__subtitle'>口感</div><div class='collapse__wrap-text'>酒体和谐、丰富、饱满、单宁柔顺、平衡.</div>`,
      },
      {
        title: "情况说明",
  ...
  },
  {
    ...
    wineInfo: [
      ...
      {
        title: "口感",
        content: `<div class='collapse__subtitle'>色泽</div><div class='collapse__wrap-text'>宝石红色</div><div class='collapse__subtitle'>香气</div><div class='collapse__wrap-text'>浓郁的黑加仑香气、香草和淡雅的烟熏味.</div><div class='collapse__subtitle'>口感</div><div class='collapse__wrap-text'>层次丰富,单宁柔和,酸度适中,非常适合配餐.</div>`,
      },
      {
        title: "情况说明",
  ...
  },
  {
    ...
    wineInfo: [
      ...
      {
        title: "情况说明",
        content: `<div class='collapse__subtitle'>葡萄酒产区: <span class='collapse__subtitle-expand'>朗格多克大区</span></div><div class='collapse__subtitle'>酿造方式: <span class='collapse__subtitle-expand'>酿酒师门精选成熟的葡萄,组织在夜间手工采收.采收后的葡萄立即送往酒窖,采用气囊压榨的方式轻柔压榨葡萄,严格控制温度16~18°C,在不锈钢罐里发酵葡萄汁,以获得细腻优雅的葡萄酒. 在不锈钢桶12个月, 橡木桶陈放6个月.</span></div><div class='collapse__subtitle'>葡萄酒分析: <span class='collapse__subtitle-expand'>酒精度: 13%, 适饮温度: 10~12°C</span></div><div class='collapse__subtitle'>葡萄品种: <span class='collapse__subtitle-expand'>100% 莎当妮(Chardonnay)</span></div>`,
      },
    ],
  },
]
